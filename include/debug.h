...
#else
#define malloc(size) checked_malloc(size, __func__, __FILE__, __LINE__)
#define realloc(ptr, new_size) checked_realloc(ptr, new_size, __func__, __FILE__, __LINE__)
#define memalign(alignment, size) checked_memalign(alignment, size, __func__, __FILE__, __LINE__)
#define assert(expression) ((void)((expression) || (assert_fail(#expression, __func__, __FILE__, __LINE__), 0)))
